...
async function main() {
  ...
  console.log("Deploying Simple DAOFactory to testnet with account:", deployer.address);
  ...
  try {
    ...
    // 3. Deploy Simple DAOFactory
    console.log("\n3. Deploying Simple DAOFactory...");
    ...
    console.log("✅ Simple DAOFactory deployed to:", await daoFactory.getAddress());
    ...
    console.log("\n🎉 Simple DAOFactory deployment completed successfully!");
    console.log("\n📋 Contract Addresses:");
    console.log("SoulboundIdentityNFT:", await identityNFT.getAddress());
    console.log("AIOracle:", await aiOracle.getAddress());
    console.log("Simple DAOFactory:", await daoFactory.getAddress());
